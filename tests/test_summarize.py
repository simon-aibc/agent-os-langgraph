...
def test_summary_preserves_gist():
    ...
    msgs = [
        HumanMessage(content="My secret password is 'OpenSesame123'. Do not forget it.", id="1"),
        AIMessage(content="Got it.", id="2"),
    ]
    # Add filler messages to exceed threshold
    for i in range(20):
        msgs.append(HumanMessage(content="Tell me a joke about a duck." * 10, id=f"f{i}"))
